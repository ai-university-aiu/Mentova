...
├── papers/         185 scientific papers — one per accomplishment and benchmark milestone
├── announcements/  132 announcements — one per accomplishment
...
132 announcements in LinkedIn format — one per accomplishment.
