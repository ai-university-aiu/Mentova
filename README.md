...
├── papers/         183 scientific papers — one per accomplishment and benchmark milestone
├── announcements/  130 announcements — one per accomplishment
...
130 announcements in LinkedIn format — one per accomplishment.
