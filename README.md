...
├── papers/         186 scientific papers — one per accomplishment and benchmark milestone
├── announcements/  133 announcements — one per accomplishment
...
133 announcements in LinkedIn format — one per accomplishment.
