...
├── papers/         184 scientific papers — one per accomplishment and benchmark milestone
├── announcements/  131 announcements — one per accomplishment
...
131 announcements in LinkedIn format — one per accomplishment.
